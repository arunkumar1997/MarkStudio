...
## Status: 🟢 Phase A (design) — COMPLETE · 🟢 Phase B (pure modules) — COMPLETE · 🟡 Phase C (service + commands) — NEXT
...
- `npm run typecheck` — ✅ green (Phase B)
- `npm run typecheck:test` — ✅ green (Phase B)
