...
export function createEditor(options: CreateEditorOptions): MarkStudioEditor {
    ...
    const initialSelection = resolveInitialSelection(initialCursor, initialText.length);
    ...
    const view = new EditorView({
        ...
        state: EditorState.create({
            ...
            extensions: [...buildExtensions(initialConfig), updateListener, snapshotListener]
        })
    });
